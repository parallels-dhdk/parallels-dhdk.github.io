$(document).ready(function () 
    ...
    $("#2040").click(function() {
        ...
        $("#mainbody").html("")
        $("#mainbody").load('index-text.html', function(){ //callback function: what is invoked after the first function if that first function completes
  ...
  function foo(item, container) //Animated link in 2040 homepage
  {
